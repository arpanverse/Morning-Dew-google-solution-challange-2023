...
class add_textfield extends StatelessWidget{
   var acct_stories = TextEditingController() ;
  @override
  ...
  Container(
   ...
   InkWell(
          onTap: () {
            acct_story.add(acct_stories.text.toString());
            Navigator.push(context,MaterialPageRoute(builder: (context) => add_type_task()),);
          },
           child: Row(
             children: [
               Container(
